...
const Modal = () => {
    ...
    const captionRef = useRef<any | null>(null)
            ...
            >
                <div className="flex min-h-[800px] items-end justify-center px-4 pt-4 pb-20 text-center sm:block sm:min-h-screen sm:p-0">
                    ...
                    <Transition.Child
                        ...
                        leaveTo="opacity-0"
                    >
                        <div className="inline-block transform overflow-hidden rounded-lg bg-white px-4 pt-5 pb-4 text-left align-bottom shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-screen-sm sm:p-6 sm:align-middle">
                            <div>
                                {selectedFile ? (
                                    <img
